...
$query = "SELECT validated FROM vulnerabilities WHERE id = 3";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'Désactiver') {
        $sql = "UPDATE vulnerabilities SET validated = FALSE WHERE id = 3";
        ...
        $sql = "UPDATE vulnerabilities SET validated = TRUE WHERE id = 3";
        if ($conn->query($sql) === TRUE) {
...
<form method="post">
    <input type="text" name="input" placeholder="Votre nom">
